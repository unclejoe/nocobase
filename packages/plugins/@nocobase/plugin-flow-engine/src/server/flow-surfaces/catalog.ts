...
const NODE_CONTRACT_ENTRIES: Array<[string, FlowSurfaceNodeContract]> = [
  ...
  ['SubmitForApprovalActionModel', SIMPLE_ACTION_CONTRACT],
...
const actionRegistry: FlowSurfaceActionRegistryItem[] = [
  ...
  {
    publicKey: 'submitForApproval',
    label: 'Submit for approval',
    scope: 'record',
    scene: 'record',
    use: 'SubmitForApprovalActionModel',
    ownerPlugin: '@nocobase/plugin-workflow-approval',
    allowedContainerUses: RECORD_ACTION_CONTAINER_USES,
    createSupported: true,
  },
  {
